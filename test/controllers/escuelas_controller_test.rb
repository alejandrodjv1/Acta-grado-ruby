...
class EscuelasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create escuela" do
    assert_difference("Escuela.count") do
      post escuelas_url, params: { escuela: { cod_e: @escuela.cod_e, nom_e: @escuela.nom_e } }
    end
  ...
  test "should update escuela" do
    patch escuela_url(@escuela), params: { escuela: { cod_e: @escuela.cod_e, nom_e: @escuela.nom_e } }
